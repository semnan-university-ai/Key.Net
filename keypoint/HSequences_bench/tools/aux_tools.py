...
def nll_check_tensorboard_directory():
    check_directory('drive/MyDrive/keypoint/keyNet/logs_network')
    check_directory('drive/MyDrive/keypoint/keyNet/logs_network/KeyNet_default')